...
class TestConfigDasanNOSDriver(unittest.TestCase, TestConfigNetworkDriver):
    ...
    def setUpClass(cls):
        ...
        username = 'vagrant'
        password = 'vagrant'
        cls.vendor = 'dasan-nos'

        optional_args = {'port': 12443, }
        cls.device = dasan_nos.DasanNOSDriver(hostname, username, password, timeout=60,
