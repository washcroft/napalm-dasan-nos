...
class DasanNOSDriver(NetworkDriver):
    ...
    def __init__(self, hostname: str, username: str, password: str, timeout: int = 60, optional_args: Dict[str, Any] = None):
        ...
        if self.optional_args.get('username', False):
            self.username = self.optional_args.get('username')        
        if self.optional_args.get('password', False):
            self.password = self.optional_args.get('password')
    ...
    def get_route_to(self, destination: str = "", protocol: str = "", longer: bool = False) -> Dict[str, models.RouteDict]:
    ...
    def ping(self, destination: str, source: str = "", ttl: int = 255, timeout: int = 2, size: int = 100, count: int = 5, vrf: str = "", source_interface: str = "") -> models.PingResultDict:
    ...
    def traceroute(self, destination: str, source: str = "", ttl: int = 255, timeout: int = 2, vrf: str = "") -> models.TracerouteResultDict:
